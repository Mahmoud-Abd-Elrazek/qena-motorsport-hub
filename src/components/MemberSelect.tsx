...
import { Check, ChevronsUpDown, Linkedin, Loader2, UserPlus, Calendar } from "lucide-react"; 
...
export default function ProfessionalMemberSelect({ members, formData, setFormData, fetchMembers }) {
  ...
  const handleSave = async () => {
    ...
    if (!formAddData.name || !formAddData.role || !formAddData.specialization || !formAddData.bio || !formAddData.year) {
    ...
    try {
      ...
      setFormAddData({
        name: "", role: "", specialization: "", year: new Date().getFullYear(), bio: "", points: 0, linkedInUrl: "", image: null
      });
  ...
  return (
    <div className="grid gap-2 text-start" dir={dir}>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-xl max-h-[100vh] overflow-y-auto p-5" dir={dir}>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="grid gap-2 text-start">
                ...
                <Input 
                    ...
                    min="2000" 
                    max="2099" 
                    value={formAddData.year} 
                    onChange={(e) => setFormAddData({ ...formAddData, year: parseInt(e.target.value) || 0 })} 
                />
              </div>
            </div>
